...
void Initialize() {
	...
	glMatrixMode(GL_PROJECTION);//It sets the current matrix mode
	glLoadIdentity();//clears current matrix and replaces it with identity matrix
	gluOrtho2D(0, 699,0,799);// multiplies the current matrix with orthogonal matrix
}
